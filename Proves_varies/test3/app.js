...
let cotxe3 = new Cotxe(2000, "BMW", "2451JDG", "vermell", "benzina");
let cotxe4 = new Cotxe(2000, "Audi", "2452LHI", "platejat", "gasoil");
let cotxe5 = new Cotxe(2000, "RangeRover", "2455GJD", "verd", "electric");
let cotxe6 = new Cotxe(2000, "Porsche", "2456GJD", "gris", "gasoil");
